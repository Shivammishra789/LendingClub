...
loans_def_raw_df = spark.read \
    ...
    .option('inferSchema', True) \
    .option("header",True) \
    .load("C:/Users/Vaishnavi/pyspark/lendingclubproject/raw/loans_defaulters_csv")
...
loans_def_delinq_df.write \
    ...
    .format("csv") \
    .mode("overwrite") \
    .option("path", "C:/Users/Vaishnavi/pyspark/lendingclubproject/raw/cleaned/loans_defaulters_deling_csv") \
    .save()

loans_def_delinq_df.write \
    .format("parquet") \
    .mode("overwrite") \
    .option("path", "C:/Users/Vaishnavi/pyspark/lendingclubproject/raw/cleaned/loans_defaulters_deling_parquet") \
    .save()
...
loans_def_records_enq_df.write \
    ...
    .format("csv") \
    .mode("overwrite") \
    .option("path", "C:/Users/Vaishnavi/pyspark/lendingclubproject/raw/cleaned/loans_defaulters_records_enq_csv") \
    .save()

loans_def_records_enq_df.write \
    .format("parquet") \
    .mode("overwrite") \
    .option("path", "C:/Users/Vaishnavi/pyspark/lendingclubproject/raw/cleaned/loans_defaulters_records_enq_parquet") \
    .save()
...
loans_def_detail_records_enq_df.write \
    ...
    .format("csv") \
    .mode("overwrite") \
    .option("path", "C:/Users/Vaishnavi/pyspark/lendingclubproject/raw/cleaned/loans_def_detail_records_enq_df_csv") \
    .save()
...
loans_def_detail_records_enq_df.write \
    .format("parquet") \
    .mode("overwrite") \
    .option("path", "C:/Users/Vaishnavi/pyspark/lendingclubproject/raw/cleaned/loans_def_detail_records_enq_df_parquet") \
    .save()
